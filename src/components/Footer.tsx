        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-sm text-gray-300 mb-4">
              Interesado en nuestro servicio? Simplemente levante el teléfono y llámenos.
            </p>
          ...
          {/* Contacto Email */}
          <div className="text-center lg:text-left">
            <h3 className="text-lg font-semibold text-white mb-4">Contacto correo</h3>
            <p className="text-sm text-gray-300 mb-4">
              A veces necesitas un poco de orientación. No se preocupe, estamos aquí para ayudarlo.
            </p>
            <div className="flex items-center justify-center lg:justify-start space-x-2">
              <EnvelopeIcon className="h-5 w-5 text-blue-400" />
              <a 
                href="mailto:iscor@iscorcolombia.com" 
                className="text-lg font-semibold text-white hover:text-blue-400 transition-colors duration-200"
              >
                iscor@iscorcolombia.com
              </a>
            </div>
          </div>
